...
Ошибки: `NOT_FOUND` (404, `crud/action.py:491-495`) и `FORBIDDEN` (403, `crud/action.py:496-500`,
...
| **осталось** · откуда у нового арендатора берутся валюты, единицы, правила пересчёта и статусы | графа 1; решение владельца |
...
| **осталось** · остаётся ли у валюты курс `exchangeRate` | разделы валют; решение владельца (БАГ-05) |
| **осталось** · чем владеет список валют карточки поставщика — настройками или кодом | графа 1; решение владельца |
| **осталось** · какой из двух источников валюты по умолчанию главный | графа 1 и раздел `PATCH /api/settings/constants`; решение владельца |
| **осталось** · рождает ли уведомление смена НДС, валюты по умолчанию или набора статусов | графа 2; решение владельца |
| **осталось** · остаётся ли след в аудит-логе и кто его автор | графа 3; решение владельца |
| **осталось** · какое право нужно, чтобы править настройки, и одно ли оно на семь вкладок | графа 7; решение владельца |
| **осталось** · где живёт и кем редактируется матрица прав заказа | графа 7 и раздел прав; решение владельца |

...
| **осталось** · кому принадлежат валюта платежа, размер страницы и перечень размеров | графа 1; решение владельца (`00-решения-владельца.md:325`) |
...
| **осталось** · что обязано попадать в журнал платежа и чем должен быть автор записи | графа 3; решение владельца (`:327`) |
...
| **осталось** · нужно ли право на правку счёта поставщика, на прикрепление и удаление документа, и кто вправе читать архив целиком | графа 7; решение владельца (`:330`) |

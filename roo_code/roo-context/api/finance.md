...
`direction` у всех строк один: сид состоит из пяти `'outgoing'`, входящей записи в нём нет ни одной
(`grep -c "direction: 'incoming'" frontend_vue/src/services/mocks/finance.ts` → 0).

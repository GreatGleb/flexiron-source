...
черновиков, §16 соглашений. Что обязано быть атомарным между аплоадом и Save — **осталось**: П43
назвал атомарными заказ и склад, а справочники и настройки оставил как есть, и финансовая запись
не отнесена ни туда, ни туда (§15 соглашений).
...
| **решено 2026-09-09 наполовину** · неприкреплённый файл убирает уборщик черновиков (П31, [§16](00-conventions.md)). **Осталось:** атомарность аплоада и Save — П43 назвал атомарными заказ и склад, а справочники и настройки оставил как есть; финансовая запись не отнесена ни туда, ни туда | графа 8; [§15](00-conventions.md), решение владельца (`:331`) |

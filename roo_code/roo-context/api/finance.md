...
| **вопрос владельцу (куст 4)** · `document_count` — та же «хранимая колонка против производного», что у поставщика и категории; кто наполняет архив документов — часть того же вопроса | графа 9; [§17](00-conventions.md) |

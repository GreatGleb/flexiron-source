...
- **снято 2026-09-09 наполовину:** ключ домену не нужен — создание взаимодействия обратимо, а
  ...
  задвоится. **Осталось:** атомарность самого Save — П43 назвал атомарными заказ и склад, а
  карточку клиента не отнёс ни к ним, ни к справочникам.
...
- закрыто: ни `Idempotency-Key`, ни версия сущности не шлются
  ...
  применяться одной транзакцией — **осталось**: П43 назвал атомарными заказ и склад, а справочники
  и настройки оставил как есть; карточка клиента не отнесена ни туда, ни туда.

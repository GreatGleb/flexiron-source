...
| **вопрос владельцу (куст 4)** · обновляет ли приём ответа `lastBccDate` и `priceHistory` поставщика — тот же вопрос, что и «хранимая колонка против производного»: у поставщика обе колонки существуют и не пишутся никем | графа 5 (4); [§17](00-conventions.md) |

...
был БАГ-01. Что делать, если письмо ушло, а строки не записались, — по-прежнему строка владельцу:
мок обе записи делает подряд, без общей границы, откатить первую при падении второй ему нечем.
...
| **осталось** · что делать, если письмо ушло, а строки не записались: мок делает обе записи подряд, без общей границы | графа 8; решение владельца |

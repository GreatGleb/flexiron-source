...
- **занижал остаток** — `warehouse/refactor-warehouse-mock-data.md` числится как «разделение на
  пять файлов выполнено», а `mocks/warehouse.ts` — по-прежнему один файл в 1959 строк;

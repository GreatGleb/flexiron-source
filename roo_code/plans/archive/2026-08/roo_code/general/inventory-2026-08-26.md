...
> **Пути ниже — на дату прогона.** 2026-08-29 все 48 планов раздела 2 («Можно закрыть»)
> уехали в `roo_code/plans/archive/2026-08/roo_code/<домен>/`, сохранив имя файла и домен.
> Таблицы не переписаны: это отчёт прогона, а не указатель — он говорит, что было
> на 2026-08-26. Раздел 1 («Работа») не тронут, его планы лежат на прежних местах.
...
| `roo_code/plans/archive/2026-08/review-followups.md` | частично | из 22 разделов сделано 8, остальные частично или не начаты | [`part-015.md`](inventory-parts/part-015.md) |

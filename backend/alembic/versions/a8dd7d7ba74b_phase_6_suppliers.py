...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("company_translations", postgresql.JSONB(), nullable=False, server_default="{}"),
        sa.Column("email", sa.String(255), nullable=False),
        sa.Column("contact_person_translations", postgresql.JSONB(), nullable=True, server_default="{}"),
        ...
        sa.Column("status_reason_translations", postgresql.JSONB(), nullable=True, server_default="{}"),
    ...
    op.create_table(
        ...
        sa.Column("user_name_translations", postgresql.JSONB(), nullable=False, server_default="{}"),
        sa.Column("user_initials", sa.String(10), nullable=False),
        sa.Column("property_translations", postgresql.JSONB(), nullable=False, server_default="{}"),

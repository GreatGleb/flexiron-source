...
class Currency(UUIDMixin, TimestampMixin, Base):
    ...
    name_lt: Mapped[str] = mapped_column(String(100), nullable=False)
...
class Uom(UUIDMixin, TimestampMixin, Base):
    ...
    code_ru: Mapped[str] = mapped_column(String(20), nullable=False)
    code_en: Mapped[str] = mapped_column(String(20), nullable=False)
    code_lt: Mapped[str] = mapped_column(String(20), nullable=False)
    name_ru: Mapped[str] = mapped_column(String(100), nullable=False)
    name_en: Mapped[str] = mapped_column(String(100), nullable=False)
    name_lt: Mapped[str] = mapped_column(String(100), nullable=False)

...
const STORE: Category[] = [
  {
    ...
    parentId: null,
    description: {
      ru: 'Все виды металлопродукции',
      en: 'All types of metal products',
      lt: 'Visi metalo gaminių tipai',
    },
    fieldCount: 3,
    productCount: 0,
    inheritedFields: [],
    fields: [
      ...
      {
        id: 'f-1-2',
        name: { ru: 'Стандарт / ГОСТ', en: 'Standard / GOST', lt: 'Standartas / GOST' },
        type: 'text',
        required: false,
        order: 1,
        options: [],
      ...
      {
        id: 'f-1-3',
        name: { ru: 'Плотность (кг/м³)', en: 'Density (kg/m³)', lt: 'Tankis (kg/m³)' },
        type: 'number',
        required: false,
        order: 2,
        options: [],
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Плоские металлические листы',
      en: 'Flat-rolled metal sheets',
      lt: 'Plokščiai valcuoti metalo lakštai',
    },
    fieldCount: 5,
    productCount: 12,
    inheritedFields: [
    ...
    fields: [
      {
        id: 'f-2-1',
        name: { ru: 'Толщина (мм)', en: 'Thickness (mm)', lt: 'Storis (mm)' },
        type: 'number',
        required: true,
        order: 0,
        options: [],
      ...
      {
        id: 'f-2-3',
        name: { ru: 'Ширина (мм)', en: 'Width (mm)', lt: 'Plotis (mm)' },
        type: 'number',
        required: false,
        order: 2,
        options: [],
      ...
      {
        id: 'f-2-4',
        name: { ru: 'Длина (мм)', en: 'Length (mm)', lt: 'Ilgis (mm)' },
        type: 'number',
        required: false,
        order: 3,
        options: [],
      ...
      {
        id: 'f-2-5',
        name: { ru: 'Вес на м² (кг)', en: 'Weight per m² (kg)', lt: 'Svoris m² (kg)' },
        type: 'number',
        required: false,
        order: 4,
        options: [],
  ...
  },
  {
    ...
    fields: [
      {
        id: 'f-3-1',
        name: { ru: 'Сплав', en: 'Alloy', lt: 'Lydinys' },
        type: 'enum',
        required: true,
        order: 0,
        options: [
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Трубные металлические изделия',
      en: 'Tubular metal products',
      lt: 'Vamzdiniai metalo gaminiai',
    },
    fieldCount: 7,
    productCount: 8,
    inheritedFields: [
    ...
    fields: [
      {
        id: 'f-4-1',
        name: { ru: 'Диаметр (мм)', en: 'Diameter (mm)', lt: 'Skersmuo (mm)' },
        type: 'number',
        required: true,
        order: 0,
        options: [],
      ...
      {
        id: 'f-4-2',
        name: { ru: 'Толщина стенки (мм)', en: 'Wall thickness (mm)', lt: 'Sienelės storis (mm)' },
        type: 'number',
        required: true,
        order: 1,
        options: [],
      ...
      {
        id: 'f-4-4',
        name: { ru: 'Тип трубы', en: 'Pipe type', lt: 'Vamzdžio tipas' },
        type: 'enum',
        required: false,
        order: 3,
        options: [
      ...
      {
        id: 'f-4-5',
        name: { ru: 'Радиус гиба (мм)', en: 'Bend radius (mm)', lt: 'Lenkimo spindulys (mm)' },
        type: 'number',
        required: false,
        order: 4,
        options: [],
      ...
      {
        id: 'f-4-7',
        name: { ru: 'Вес на метр (кг)', en: 'Weight per meter (kg)', lt: 'Svoris metrui (kg)' },
        type: 'number',
        required: false,
        order: 6,
        options: [],
  ...
  },
  {
    ...
    fields: [
      {
        id: 'f-5-1',
        name: { ru: 'Единица измерения', en: 'Unit of measure', lt: 'Matavimo vienetas' },
        type: 'enum',
        required: true,
        order: 0,
        options: [
      ...
      {
        id: 'f-5-2',
        name: { ru: 'Опасный материал', en: 'Hazardous material', lt: 'Pavojinga medžiaga' },
        type: 'boolean',
        required: false,
        order: 1,
        options: [],
      ...
      {
        id: 'f-5-3',
        name: { ru: 'Срок годности', en: 'Expiry date', lt: 'Galiojimo data' },
        type: 'date',
        required: false,
        order: 2,
        options: [],
  ...
  },
  {
    ...
    fields: [
      {
        id: 'f-6-1',
        name: { ru: 'Производитель', en: 'Manufacturer', lt: 'Gamintojas' },
        type: 'text',
        required: true,
        order: 0,
        options: [],
      ...
      {
        id: 'f-6-2',
        name: { ru: 'Гарантия (мес)', en: 'Warranty (months)', lt: 'Garantija (mėn)' },
        type: 'number',
        required: false,
        order: 1,
        options: [],
      ...
      {
        id: 'f-6-3',
        name: { ru: 'Email поставщика', en: 'Supplier email', lt: 'Tiekėjo el. paštas' },
        type: 'email',
        required: false,
        order: 2,
        options: [],
      ...
      {
        id: 'f-6-4',
        name: { ru: 'Паспорт оборудования', en: 'Equipment passport', lt: 'Įrangos pasas' },
        type: 'file',
        required: false,
        order: 3,
        options: [],
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Строительные стальные балки IPE/HEA/HEB',
      en: 'IPE/HEA/HEB structural steel beams',
      lt: 'IPE/HEA/HEB konstrukcinės plieno sijos',
    },
    fieldCount: 7,
    productCount: 0,
    inheritedFields: [
    ...
    fields: [
      {
        id: 'f-7-1',
        name: { ru: 'Тип профиля', en: 'Profile type', lt: 'Profilio tipas' },
        type: 'enum',
        required: true,
        order: 0,
        options: [
      ...
      {
        id: 'f-7-2',
        name: { ru: 'Высота (мм)', en: 'Height (mm)', lt: 'Aukštis (mm)' },
        type: 'number',
        required: true,
        order: 1,
        options: [],
      ...
      {
        id: 'f-7-3',
        name: { ru: 'Ширина полки (мм)', en: 'Flange width (mm)', lt: 'Flanšo plotis (mm)' },
        type: 'number',
        required: false,
        order: 2,
        options: [],
      ...
      {
        id: 'f-7-4',
        name: { ru: 'Толщина полки (мм)', en: 'Flange thickness (mm)', lt: 'Flanšo storis (mm)' },
        type: 'number',
        required: false,
        order: 3,
        options: [],
      ...
      {
        id: 'f-7-5',
        name: { ru: 'Толщина стенки (мм)', en: 'Web thickness (mm)', lt: 'Sienelės storis (mm)' },
        type: 'number',
        required: false,
        order: 4,
        options: [],
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Стальные швеллеры (UPN/UPE)',
      en: 'Steel channel sections (UPN/UPE)',
      lt: 'Plieniniai šveleriai (UPN/UPE)',
    },
    fieldCount: 6,
    productCount: 0,
    inheritedFields: [
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Равнополочные и неравнополочные стальные уголки',
      en: 'Equal and unequal steel angle bars',
      lt: 'Lygiakraščiai ir nelygiakraščiai plieno kampainiai',
    },
    fieldCount: 6,
    productCount: 0,
    inheritedFields: [
    ...
    fields: [
      {
        id: 'f-9-1',
        name: { ru: 'Ширина полки (мм)', en: 'Side width (mm)', lt: 'Šono plotis (mm)' },
        type: 'number',
        required: true,
        order: 0,
        options: [],
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Арматурные стальные стержни',
      en: 'Reinforcement steel bars',
      lt: 'Armatūriniai plieno strypai',
    },
    fieldCount: 6,
    productCount: 0,
    inheritedFields: [
    ...
    fields: [
      ...
      {
        id: 'f-10-3',
        name: { ru: 'Класс', en: 'Class', lt: 'Klasė' },
        type: 'enum',
        required: false,
        order: 2,
        options: [
      ...
      {
        id: 'f-10-6',
        name: { ru: 'Предел текучести (МПа)', en: 'Yield strength (MPa)', lt: 'Takumo riba (MPa)' },
        type: 'number',
        required: false,
        order: 5,
        options: [],
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Квадратные и прямоугольные полые профили, полоса, круг',
      en: 'Square and rectangular hollow sections, flat and round bars',
      lt: 'Kvadratiniai ir stačiakampiai tuščiaviduriai profiliai, plokščios ir apvalios juostos',
    },
    fieldCount: 6,
    productCount: 0,
    inheritedFields: [
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Стальная проволока в бухтах и на катушках',
      en: 'Steel wire in coils and spools',
      lt: 'Plieninė viela ritėse ir ant būgnų',
    },
    fieldCount: 5,
    productCount: 0,
    inheritedFields: [
    ...
    fields: [
      ...
      {
        id: 'f-12-2',
        name: { ru: 'Покрытие', en: 'Coating', lt: 'Danga' },
        type: 'enum',
        required: false,
        order: 1,
        options: [
      ...
      {
        id: 'f-12-3',
        name: { ru: 'Вес бухты (кг)', en: 'Spool weight (kg)', lt: 'Ritės svoris (kg)' },
        type: 'number',
        required: false,
        order: 2,
        options: [],
  ...
  },
  {
    ...
    parentId: 'cat-1',
    description: {
      ru: 'Трубные фитинги и соединители',
      en: 'Pipe fittings and connectors',
      lt: 'Vamzdžių jungtys ir adapteriai',
    },
    fieldCount: 5,
    productCount: 0,
    inheritedFields: [
    ...
    fields: [
      ...
      {
        id: 'f-13-2',
        name: { ru: 'Размер DN (мм)', en: 'Size DN (mm)', lt: 'Dydis DN (mm)' },
        type: 'number',
        required: true,
        order: 1,
        options: [],
      ...
      {
        id: 'f-13-4',
        name: { ru: 'Тип соединения', en: 'Connection type', lt: 'Jungties tipas' },
        type: 'enum',
        required: false,
        order: 3,
        options: [
      ...
      {
        id: 'f-13-5',
        name: { ru: 'Вес (кг)', en: 'Weight (kg)', lt: 'Svoris (kg)' },
        type: 'number',
        required: false,
        order: 4,
        options: [],
...
export function mockPatchCategory(
  ...
  if (delta.description !== undefined)
    cat.description = mergeTranslatedString(
      cat.description as TranslatedString,
      delta.description as TranslatedString,
    )

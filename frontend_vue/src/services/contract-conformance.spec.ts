...
/**
 * Включён 2026-09-10 задачей 20 плана: все 17 доменов сведены, 175 эндпоинтов из 175, — то есть
 * условие включения выполнено, и шаг гейта вводится зелёным, как и требовал план.
 *
 * С этого момента новый домен в коде без доменного файла краснеет сразу. Пока флаг был false,
 * такой домен проходил гейт молча — ровно тот класс расхождения, ради которого гейт и заводили.
 */
const EXPECT_ALL_DOMAINS: boolean = true

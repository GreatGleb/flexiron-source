...
<template>
  ...
  >
    <template v-if="name === 'pie-chart'">
      <path d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
      <path d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
    </template>
    <template v-else-if="name === 'grid-products'">
      <path
        d="M7 7h.01M7 11h.01M7 15h.01M11 7h.01M11 11h.01M11 15h.01M15 7h.01M15 11h.01M15 15h.01M19 7h.01M19 11h.01M19 15h.01M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z"
      />
    </template>
    <template v-else-if="name === 'warehouse-box'">
      <path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
    </template>
    <template v-else-if="name === 'staff-user'">
      <path
    ...
    <template v-else-if="name === 'x-close'">
      <line x1="18" y1="6" x2="6" y2="18" />
      <line x1="6" y1="6" x2="18" y2="18" />
    </template>
    <template v-else-if="name === 'menu-bars'">
      <path d="M3 12h18M3 6h18M3 18h18" />
    </template>
    <template v-else-if="name === 'search'">
      <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
    </template>
    <template v-else-if="name === 'bell-notification'">
      <path
    ...
    <template v-else-if="name === 'plus-add'">
    ...
    <template v-else-if="name === 'edit-pencil'">
    ...
    <template v-else-if="name === 'save-floppy'">

...
const pageTitle = computed(() =>
  movement.value
    ? t('warehouse.movement_card_title', { id: movement.value.id, productName: tf(movement.value.productName) })
...
<template>
  ...
  <template v-if="error">
    ...
    <div class="entity-not-found" data-test="movement-card-error">
      ...
      <router-link :to="{ name: 'admin-warehouse', params: { tab: 'movements' } }" class="btn btn-primary">
  ...
  <template v-else>
    <div class="page-movement-card" data-test="movement-card-page">
      <div v-if="movement" class="movement-card-header" data-test="movement-card-header">
        <Breadcrumb
          :items="[
            { label: t('warehouse.header_title'), to: { name: 'admin-warehouse', params: { tab: 'movements' } } },
            { label: t('warehouse.tab_movements'), to: { name: 'admin-warehouse', params: { tab: 'movements' } } },
            { label: t('warehouse.movement_card_title', { id: movement?.id ?? id, productName: movement ? tf(movement.productName) : '' }) },
          ]"
        />
        <div class="movement-card-header-row">
          <h1 class="page-title">
            {{ t('warehouse.movement_card_title', { id: movement?.id ?? id, productName: movement ? tf(movement.productName) : '' }) }}
            <router-link
          ...
          <div class="entity-action-bar no-margin pos-static" data-test="movement-card-save-bar">
          </div>
        </div>
      </div>
      ...
      <div v-if="movement || loading" class="main-card-content" data-test="movement-card-content">
        ...
        <div class="entity-card-grid">
          ...
          <div class="entity-col-center">
            <GlassPanel :loading="loading" :skeleton-rows="4" data-test="movement-card-center-panel">
              <template v-if="movement">
              <div class="input-group">
                <label class="field-label">
              ...
              <div class="input-group">
                ...
                <template v-if="movement.referenceType && movement.referenceType.startsWith('offcut_') && movement.referenceId">
                  <router-link
            ...
            <GlassPanel :loading="loading" :skeleton-rows="4" data-test="movement-card-right-panel">
              ...
              <div class="input-group">
                <label class="field-label">
                  ...
                  <span v-tooltip="t('warehouse.movement_field_from_location_hint')" class="info-hint">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                      <circle cx="12" cy="12" r="10" />
                      <line x1="12" y1="16" x2="12" y2="12" />
                      <line x1="12" y1="8" x2="12.01" y2="8" />
              ...
              <div class="input-group">
                <label class="field-label">
                  ...
                  <span v-tooltip="t('warehouse.movement_field_to_location_hint')" class="info-hint">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                      <circle cx="12" cy="12" r="10" />
                      <line x1="12" y1="16" x2="12" y2="12" />
                      <line x1="12" y1="8" x2="12.01" y2="8" />
          ...
          <GlassPanel :title="t('warehouse.section_batch_audit')">
            ...
            <template v-else>
              <table class="audit-log-table" data-test="movement-card-audit-table">
                ...
                <tbody>
                  <tr v-for="(entry, index) in auditLog" :key="index" data-test="movement-card-audit-row">

...
export const adminBcc = {
  ru: {
    bcc: {
      ...
      sender_missing: 'Почтовый сервер не настроен — открыть настройки',
      subject_label: 'Тема',
  ...
  en: {
    bcc: {
      ...
      sender_label: 'From:',
      sender_missing: 'Mail server is not configured — open settings',
  ...
  lt: {
    bcc: {
      ...
      sender_missing: 'Pašto serveris nesukonfigūruotas — atidaryti nustatymus',
      subject_label: 'Tema',

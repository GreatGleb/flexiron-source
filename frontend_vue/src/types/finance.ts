...
export interface Receivable {
  ...
  paidAmount: number
  /**
   * Остаток к оплате. МОЖЕТ БЫТЬ ОТРИЦАТЕЛЬНЫМ — так выглядит переплата, и
   * скрывать её нельзя: ноль на её месте читается как «сведено в ноль», хотя
   * клиенту должны. То же правило и в `domain/receivable.ts`.
   */

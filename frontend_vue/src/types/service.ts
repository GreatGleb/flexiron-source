 ...
 * ровно то, что чинилось в оплатах и в ленте логов. У товара такое поле было
 * (`Product.priceUnit`, помечено legacy) и жило ради одного места, которое к тому же
 * собирало подпись всегда по-английски; удалено вместе с этим местом.
 */
